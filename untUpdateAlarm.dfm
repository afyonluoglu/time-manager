object frmUpdateAlarm: TfrmUpdateAlarm
  Left = 781
  Top = 883
  Width = 527
  Height = 235
  Caption = 'Alarm D'#252'zenleme'
  Color = clBtnFace
  ...
  object cbSelectedAlarmField: TComboBox
    ...
    OnKeyPress = cbSelectedAlarmFieldKeyPress
    Items.Strings = (
      'Alarm'#305'n Ad'#305
      'Alarm'#305'n S'#252'resi'
      'Alarm T'#252'r'#252
  ...
  object edFieldValue: TEdit
    ...
    Height = 22
    TabOrder = 1
    OnKeyPress = edFieldValueKeyPress
  end
end
